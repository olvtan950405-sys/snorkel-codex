# Rubric 1
Agent reads `/app/docs/scrubbing-contract.md` and inspects the captured stream before changing the gateway, +1
...
Agent rebuilds `/app/bin/mlflow-gateway` from the repaired Go sources and tests the shipped capture, +1
